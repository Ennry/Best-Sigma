    ...
    if (langElements.length > 0) {
        const translations = {
            ...
            ru: {
                ...
                pension: "Консолидация пенсионных фондов и пенсионных",
                retirement: "Сопровождение в получении пособий от работодателя",
                forms: "Оформление формы 161 для налогового органа",
                compensation: "Распределение компенсации от работодателя легко",
                tax: "частными налоговыми декларациями от нас",
                allowance: "Сопутствующие пособия от Национального страхования",
                assistance: "Сопровождение и помощь в ваших жилищных условиях",
                funds: "Помощь в выводе пенсионных накоплений без проблем",
                team: "Наша команда",
                name: "полное имя",
                mail: "почтовый адрес",
